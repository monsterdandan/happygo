...
jQuery.fn.extend(
	{
		bigMirror:function(obj){				
				...
				BigMirrors.prototype.createBigMirrorsUI=function(left,top){
					...
					let str = "<div style='position:absolute;left:"+this.left+"px;top:"+this.top+"px;width:"+this.mirrorWidth+"px;height:"+this.mirrorHeight+"px;background-color:rgba(255,255,255,0.5)'></div>";
				...
				BigMirrors.prototype.createBigImg = function(){
					...
					let str = "<div style='position:absolute;"+leftTopStr+"width:380px;height:380px;box-shadow:2px -2px 3px #999,-2px 2px 3px #999;overflow:hidden;z-index:999'>";
					//计算宽度
